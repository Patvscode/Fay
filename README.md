...
This fork includes a tested, tailnet-only [DGX Spark deployment](deploy/dgx-spark/README.md) using a local Gemma model, Voxtral speech, persistent memory, systemd, and MCP.
